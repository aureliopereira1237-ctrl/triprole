const lugares=[
  {
    ...
    desc:"Rolê perfeito para conhecer pessoas novas e ouvir música brasileira.",
  ...
  },
  {
    ...
    tipo:"musica",
    local:"Vila boêmia",
    desc:"Lugar animado com bandas locais e clima descontraído.",
    img:"https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?auto=format&fit=crop&w=900&q=80"
  },
  {
    titulo:"Balada temática",
    tipo:"noite",
    local:"Distrito norte",
    desc:"Festa temática para sair à noite e viver a cidade.",
...
const posts=[
  ...
  },
  {
    nome:"Bianca",
    tag:"🌳 Ar livre",
    texto:"O parque estava muito bom no fim da tarde. Recomendo!"
  }
];
...
function carregarLugares(lista=lugares){
...
function filtrarMood(tipo){
  const filtrados=lugares.filter(lugar=>lugar.tipo===tipo);
  document.getElementById("tituloLista").innerText="Sugestões para seu mood";
  carregarLugares(filtrados);
}
...
function ativarLocalizacao(){
  ...
  navigator.geolocation.getCurrentPosition(
    function(posicao){
      ...
      document.getElementById("tituloLista").innerText="Lugares próximos encontrados";
      carregarLugares(lugares);
    },
    function(){
